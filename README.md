...
`render.yaml` is included for a Node web service deployment. The service exposes `/api/health`, streams Gemini responses, proxies the allow-listed AWS Marketplace MCP tools, and keeps browser automation behind the server.
